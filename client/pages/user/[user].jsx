        ...
        <>
            ...
            <main className={`relative flex max-xl:w-full flex-col xl:items-start min-h-[90svh] gap-4`}>
                <div className="absolute h-60 max-xl:h-40 w-full bg-slate-300">
                    <Image loader={() => data?.cover ? data.cover : cover} src={data?.cover ? data.cover : cover} fill className="object-cover" />
                ...
                <div className="relative flex w-full max-xl:flex-col xl:items-start justify-start pt-12 px-4 xl:px-16 xl:gap-10 gap-5">
                    ...
                    <div className="flex-1 xl:px-10 flex flex-col gap-2">
                        ...
                        <p className="text-zinc-600">{data?.about || "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore tenetur cum est quia porro fugiat voluptatem accusantium nihil, exercitationem placeat ut fugit adipisci cumque reprehenderit tempore amet earum cupiditate atque."}</p>
