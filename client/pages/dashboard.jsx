        ...
        return (
            <div id={id} className="relative flex flex-col gap-3 lg:w-[400px] w-full rounded-md p-2">
                ...
                <div className="flex flex-shrink flex-col gap-2">
                    ...
                    {date ? <span className={`text-zinc-500 font-semibold px-1 -translate-y-2`}>{date[1] + " " + date[2]}</span> : <span className={`text-zinc-300 font-semibold px-1 -translate-y-2`}>1 January, 2077</span>}
