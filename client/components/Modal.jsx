...
export default function Modal() {
    ...
    return (
        <div onClick={(e) => {
            ...
            <div id="modal" className="flex flex-col items-center gap-2 p-2 h-60 xl:w-[500px] w-[90svw] bg-white rounded-lg shadow-[rgba(0,_0,_0,_0.75_0px_10px_15px] transition-all duration-500 scale-0">
