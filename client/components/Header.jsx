        ...
        <div id="model" className="fixed opacity-0 pointer-events-none z-20 bg-white bg-opacity-100 min-h-screen w-screen transition-opacity duration-300">
            ...
            {form ?
                <div className="flex flex-col gap-5 items-center pt-20">
                    <h3 className={`${jose.className} text-4xl py-3 max-lg:py-10`}>Sign in Here.</h3>
                    ...
                    <form onSubmit={(e) => {
                        e.preventDefault()
                        fetch("http://localhost:8080/login").then(res => res.json()).then(res => {
                            console.log(res);
                        })
                    }} className="flex flex-col items-center gap-4">
                        <div className="flex flex-col gap-4 items-center">
                            <div className="flex flex-col gap-2">
                                <input id="email" className={`${jose.className} text-xl leading-none outline-none py-3 max-xl:py-4 px-4 bg-zinc-200 rounded-md focus:border-black bg-transparent w-[370px] max-w-[90svw]`} autoComplete="off" type="email" placeholder="Username or Email" required />
                                <input id="pass" className={`${jose.className} text-xl leading-none outline-none py-3 max-xl:py-4 px-4 bg-zinc-200 rounded-md focus:border-black bg-transparent w-[370px] max-w-[90svw]`} type="password" placeholder="Password" required />
                            </div>
                    ...
                    <p className="text-center text-zinc-400 absolute bottom-10 max-xl:bottom-20 text-xs w-[450px] max-w-[90svw]">Click “Sign In” to agree to Reader's Terms of Service and acknowledge that Reader's Privacy Policy applies to you.</p>
                </div> :
                <div className="flex flex-col gap-5 items-center pt-20">
                    ...
                    <form id="form" onSubmit={(e) => {
                        ...
                        fetch("http://localhost:8080/signup/mail", {
                            method: "POST",
                        ...
                        <div className="flex gap-2 items-center max-xl:max-w-[370px]">
                            ...
                            <button className="relative rounded-full flex xl:p-2 p-3 bg-blue-600 lg:hover:bg-blue-700 transition-all duration-200 overflow-hidden disabled:opacity-70 disabled:cursor-not-allowed" type="submit">
                                ...
                                <span id="load" className="bg-white absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-3 transition-all duration-200 opacity-0">
