    ...
    return (<>
        <div className={`relative flex items-center gap-3 justify-between p-4 xl:px-16`}>
            ...
            <section className="flex items-center gap-5">
                ...
                { router.pathname.split("/")[1] != "dashboard" ? <Link href={"#"} className="flex max-xl:hidden items-center gap-1 px-4 pb-1 pt-2 transition-all duration-200 border group xl:hover:border-zinc-500 border-zinc-300 rounded-xl">
