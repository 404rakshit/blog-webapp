    ...
    return (
        <div className="flex flex-col gap-3 xl:w-[400px] rounded-md p-2">
            ...
            <div className="flex flex-shrink flex-col gap-2">
                {title ? <span className={`${jose.className} text-xl line-clamp-2 mt-2 px-1 leading-6`}>{title}</span> : <span className={`${jose.className} text-xl line-clamp-1 mt-2 px-1 leading-6`}>Title</span>}
